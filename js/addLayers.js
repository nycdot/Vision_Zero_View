...
function checkInterventionBtns(interventionLayerIDs) {
	...
	//	var locID2 = 22 +  street_slider;
		var locID = 12 +  street_slider;
		var locID2 = 24 +  street_slider;
		interventionLayerIDs.push(locID, locID2);
	}
	if (hasClass('ASZBtn', 'active')){

		//var locID = 3;
		var locID = 36 +  street_slider;
		interventionLayerIDs.push(locID);
...
if (hasClass('leftTurnTrafficCalmingBtn', 'active')){
	...
	//var locID = 7;
	var locID = 84 +  street_slider;
	interventionLayerIDs.push(locID);

}

 // new Oct 2017 -->
if (hasClass('enhancedCrossingsBtn', 'active')){

	//var locID = 7;
	var locID = 96 +  street_slider;
	interventionLayerIDs.push(locID);
...
if (hasClass('VZ_Zones', 'active')){
	...
	//var locID = 10;
	var locID = 132 +  street_slider;
	interventionLayerIDs.push(locID);
}

// new OCt 2017
if (hasClass('VZ_BikeBtn', 'active')){

	//var locID = 10;
	var locID = 144 +  street_slider;
	interventionLayerIDs.push(locID);
}
