  ...
  var environment = "QA"; //QA or PROD
   ...
   //// the domain will need to be modified to run this code locally /////
	...
	var updateDate = "<a href='//www.nyc.gov/html/dot/html/about/vz_datafeeds.shtml' target='blank'><b>Data</b></a> as of " + "8/31/2017";
	var updateDate2 = "As of " + "8/31/2017"; // for dropdown menu in mobile view - index.html
	var updateDate3 = "8/31/2017";
	var updateMessage = "";
	...
	sliderMonth = 103; // August 2017
	dropdownMonth = 7; // August 2017
